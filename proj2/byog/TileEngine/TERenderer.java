...
public class TERenderer {
    ...
    public void showLocation() {
        if (StdDraw.hasNextKeyTyped()) {
            ...
            if (direction == 'Q') {
                Game.GameState gs = new Game.GameState(NewWorldGenerator.PRandomWorld, new int[]{NewWorldGenerator.playerPosition.x, NewWorldGenerator.playerPosition.y});
                try {
                    Game.saveGame("myWorld.ser", gs);
