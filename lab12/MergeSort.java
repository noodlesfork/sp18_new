...
public class MergeSort {
    ...
    private static <Item extends Comparable> Queue<Item> mergeSortedQueues(
            Queue<Item> q1, Queue<Item> q2) {
        Queue<Item> q12 = new Queue<>();
        int size = q1.size() + q2.size();
        for (int i = 0; i < size; i += 1) {
            q12.enqueue(getMin(q1, q2));
        }
        return q12;
    }
    ...
    public static <Item extends Comparable> Queue<Item> mergeSort(
        ...
        while (queues.size() > 1) {
            Queue<Item> Q = mergeSortedQueues(queues.dequeue(), queues.dequeue());
            queues.enqueue(Q);
        }
    ...
    public static void main(String[] args) {
        ...
        students.enqueue("Daniel");
        students.enqueue("Jason");
        students.enqueue("Jack");
        students.enqueue("Ethan");
        students.enqueue("Kay");
        students.enqueue("Molly");
